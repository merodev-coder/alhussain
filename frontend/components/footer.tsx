...
export default function Footer() {
  return (
    <footer className="bg-inverse-canvas text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-sans font-bold text-white mb-4">روابط سريعة</h3>
            <ul className="space-y-2">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="font-body text-sm text-white/60 hover:text-brand-primary transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          {/* Contact */}
          <div>
            <h3 className="font-sans font-bold text-white mb-4">تواصل معنا</h3>
