...
export async function connectDB() {
    ...
    if (uris.length === 0) {
        throw new Error('No MongoDB URIs found. Set MONGODB_URI and optionally MONGODB_URI_2, MONGODB_URI_3, …');
    }
...
export function getConnection(index) {
